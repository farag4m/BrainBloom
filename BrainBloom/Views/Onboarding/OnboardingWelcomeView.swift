        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                ZStack {
                    ...
                    GlassLeafIcon(
                        size: 180,
                        tint: Color(red: 0.62, green: 0.55, blue: 0.98),
                        glassTint: Color(red: 0.62, green: 0.55, blue: 0.98).opacity(0.35)
                    )
                ...
                // Body
                Text("Set daily limits on the apps that pull you in.\nWhen time is up, \(AppName.displayName) helps you pause and choose what matters.")
                    .font(.body)
